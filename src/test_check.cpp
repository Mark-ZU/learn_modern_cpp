...
namespace {
    template<typename T,typename=int T::*>        std::true_type  test1();
    template<typename T>                          std::false_type test1(...);
    template<typename T,typename=decltype(&T::f)> std::true_type  test2();
    template<typename T>                          std::false_type test2(...);
    template<typename T,typename=decltype(T::f)>  std::true_type  test3();
...
template<typename T>
inline constexpr bool check1_v = decltype(::test1<T>())::value;
template<typename T>
inline constexpr bool check2_v = decltype(::test2<T>())::value;
template<typename T>
inline constexpr bool check3_v = decltype(::test3<T>())::value;
template<typename T>
inline constexpr bool check4_v = decltype(::test4<T>())::value;
template<typename T>
inline constexpr bool check5_v = decltype(::test5<T>())::value;
